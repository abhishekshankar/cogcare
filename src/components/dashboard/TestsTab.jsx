            ...
            <div className="shrink-0 border-t border-border bg-page p-4">
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="inline-flex min-h-[44px] flex-1 items-center justify-center gap-2 rounded-full border border-border bg-white px-4 py-2 text-sm font-semibold text-forest hover:bg-surface sm:min-h-0 sm:flex-initial"
                >
